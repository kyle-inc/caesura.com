...
$auth_users = array(
    'Anurag Gautam' => '$2y$10$XQv7XCcjgEbbvdjnQVy3ceym7.B9Pq22kMKBDjiaQB9fXU4EVydcq', //admin@123
    'Ashish Gautam' => '$2y$10$XQv7XCcjgEbbvdjnQVy3ceym7.B9Pq22kMKBDjiaQB9fXU4EVydcq', //admin@123
    'Arun Kumar Gautam' => '$2y$10$XQv7XCcjgEbbvdjnQVy3ceym7.B9Pq22kMKBDjiaQB9fXU4EVydcq', //admin@12
    'KYLE.Inc' => '$2y$10$XQv7XCcjgEbbvdjnQVy3ceym7.B9Pq22kMKBDjiaQB9fXU4EVydcq', //admin@12
);
...
$favicon_path = 'caesuraicon.png';

// Files and folders to excluded from listing
// e.g. array('myfile.html', 'personal-folder', '*.php', ...)
$exclude_items = array('index.php', 'admin.php', 'caesuraicon.png', 'translation.json', 'Old Colliseum', 'google55e22d72587352f6.html');
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                                ...
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="form-group">
                                       <div class="brand">
                                            ...
                                            <img style="padding:2% 2%;" src="caesuraicon.png" alt="Caesura icon">
                                        </div>
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="https://kyle-inc.github.io/kyle.github.io/" target="_blank" class="text-muted" data-version="<?php echo VERSION; ?>">KYLE Devops</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="" target="_blank" class="app-v-title" style="color:golden;" > Caesura <?php echo VERSION; ?></a></h3></p>
                        <p>KYLE Devops</p>
                        <p>Contact Us <a href="https://kyle-web.000webhostapp.com/chat.php?user_id=123456789"> @Response</a> </p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item"><a href="https://github.com/prasathmani/tinyfilemanager/wiki" target="_blank"><i class="fa fa-question-circle"></i> <?php echo lng('Help Documents') ?> </a> </li>
                                <li class="list-group-item"><a href="https://kyle-web.000webhostapp.com/chat.php?user_id=123456789" target="_blank"><i class="fa fa-bug"></i> <?php echo lng('Report Issue') ?></a></li>
                                <li class="list-group-item"><a href="https://kyle-inc.github.io/kyle.github.io/"><i class="fa fa-link"> </i> <?php echo lng('Check Latest Version') ?></a></li>
                                <?php if(!FM_READONLY) { ?>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="https://kyle-inc.github.io/kyle.github.io/" target="_blank" class="float-right text-muted"> Caesura </a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://kyle-inc.github.io" target="_blank" class="float-right text-muted"> Caesura </a></div>
        <?php endif; ?>
    </div>
...
function fm_show_nav_path($path)
{
    ...
    <nav class="navbar navbar-expand-lg <?php echo $getTheme; ?> mb-4 main-nav <?php echo $isStickyNavBar ?>">
        <a class="navbar-brand" href=""> <img style="width:3vh;" src="caesuraicon.png" alt=""> <?php echo lng('AppTitle') ?> </a>
...
<head>
    ...
    <meta name="description" content="Caesura">
    <meta name="author" content="KYLE Devops">
    <meta name="robots" content="noindex, nofollow">
    <meta name="googlebot" content="noindex">
    <!-- Here is Icon of title -->
    <link rel="icon" href="caesuraicon.png" type="image/x-icon">
    ...
    <style>
        ...
        .message{ padding:4px 7px;border:1px transparent;background-color:transparent;}
        .message.ok{ border-color:transparent;background-color:transparent;color:#f78166;}
        .message.error{ border-color:transparent;color:red;background-color:transparent;}
        .message.alert{ border-color:transparent;color:orange;background-color:transparent;}
...
<head>
    ...
    <style>
        ...
        * { -webkit-border-radius:0 !important;-moz-border-radius:0 !important;border-radius:0 !important; }
        ...
        .nav-item.avatar a > i { font-size:16px; }
        .nav-item.avatar .dropdown-menu a { font-size:14px; }
        #search-addon { font-size:12px;border-right-width:0; }
        #search-addon2 { background:transparent;border-left:0; }
        .bread-crumb { color:#cccccc;font-style:normal; }
        #main-table .filename a { color:black; }
        ...
        .table-bordered td, .table-bordered th { border:1px solid transparent; }
        .hidden { display:none  }
        pre.with-hljs { padding:0  }
        pre.with-hljs code { margin:0;border:0;overflow:visible  }
        code.maxheight, pre.maxheight { max-height:512px  }
        .fa.fa-caret-right { font-size:1.2em;margin:0 4px;vertical-align:middle;color:#ececec  }
        .fa.fa-home { font-size:1.3em;vertical-align:bottom;color:crimson;  }
        .path { margin-bottom:10px;color:crimson; }
        form.dropzone { min-height:200px;border:2px dashed #007bff;line-height:6rem;background-color: transparent; }
        .right { text-align:right  }
        .center, .close, .login-form { text-align:center  }
        .message { padding:4px 7px;border:1px solid #ddd;background-color:transparent;  }
        .message.ok { border-color:transparent;color:#f78166;background-color:transparent  }
        .message.error { border-color:red;color:red;background-color:transparent  }
        .message.alert { border-color:orange;color:orange;background-color:transparent  }
        ...
        .inline-actions > a > i { font-size:1em;margin-left:5px;background:transparent;color:crimson;padding:3px;border-radius:3px  }
        ...
        i.fa.fa-folder-o { color:#0157b3;padding:10px; }
        i.fa.fa-picture-o { color:#26b99a;padding:10px; }
        i.fa.fa-file-archive-o { color:#da7d7d;}
        .btn-2 i.fa.fa-file-archive-o { color:inherit; }
        i.fa.fa-css3 { color:#f36fa0;padding:10px; }
        i.fa.fa-file-code-o { color:#007bff;padding:10px; }
        i.fa.fa-code { color:#cc4b4c;padding:10px; }
        i.fa.fa-file-text-o { color:#0096e6;padding:10px; }
        i.fa.fa-html5 { color:#d75e72;padding:10px;}
        i.fa.fa-file-excel-o { color:#09c55d;padding:10px; }
        i.fa.fa-file-powerpoint-o { color:#f6712e;padding:10px; }
        ...
        .app-v-title { font-size:24px;font-weight:300;letter-spacing:-.5px;text-transform:uppercase;font-family: 'Ubuntu', sans-serif; }
    ...
    if (FM_THEME == "dark"): ?>
        <style>
            body.theme-dark { background-color: #18191A; }
            .list-group .list-group-item { background: #343a40; }
            .theme-dark .navbar-nav i, .navbar-nav .dropdown-toggle, .break-word { color: white; }
            a, a:hover, a:visited, a:active, #main-table .filename a { color: silver; }
            ul#search-wrapper li:nth-child(odd) { background: #f9f9f9cc; }
            .theme-dark .btn-outline-primary { color: white; border-color: transparent; }
            .theme-dark .btn-outline-primary:hover, .theme-dark .btn-outline-primary:active { background-color: black;}
        </style>
    <?php endif; ?>
</head>
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'Caesura';      $tr['en']['AppTitle']           = 'Caesura';
    $tr['en']['Login']          = 'Sign in';                $tr['en']['Username']           = 'Username';
    $tr['en']['Password']       = 'Password';               $tr['en']['Logout']             = 'Sign Out';
    $tr['en']['Move']           = 'Move';                   $tr['en']['Copy']               = 'Copy';
    $tr['en']['Save']           = 'Save Changes';                   $tr['en']['SelectAll']          = 'Select all';
    ...
    $tr['en']['Upload']         = 'Upload';                 $tr['en']['Cancel']             = 'Close';
    ...
    $tr['en']['Help']               = 'About';               $tr['en']['Created']    = 'Created';
    ...
    $tr['en']['Check Latest Version'] = 'KYLE.github.io';$tr['en']['Generate new password hash'] = 'Generate new password hash';
